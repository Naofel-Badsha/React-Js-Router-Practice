    ...
    return (
        <div className='max-w-[1350px] mx-auto py-28'>
            <div className='flex items-center justify-between'>
                {/*-------------Heading-------------*/}
                <div>
                    <h3 className='uppercase text-center bg-[#ebe5d9] text-[#B18B5E] w-fit py-1 px-4 font-bold'>THIS MONTH</h3>
                    <h1 className='text-6xl text-center text-[#161616] sm:leading-16 md:text-6xl md:leading-16 lg:text-[52px] font-medium lg:leading-20 '>Trendy Collection</h1>
                </div>
            ...
            <div className='grid gap-10 grid-cols-1 md:grid-cols-3 lg:grid-cols-4'>
                {
                    trendys.map(trendy => <SingleTrendyCollection key={trendy.id} trendy={trendy}></SingleTrendyCollection>)
                }
